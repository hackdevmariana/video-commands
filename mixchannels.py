...
@process_image('whitedarkblueamber', "0,0,1;0,1,0;1,0,0 negate")
def whitedarkblueamber():
    """Mixes the channels giving a white, dark blue and amber tone to the image."""

@process_image('whitebluepurple', "0,0,1;1,0,0;0,0,0 negate")
def whitebluepurple():
    """Mixes the channels giving a white, blue and purple tone to the image."""

@process_image('whitedarkgreenpurple', "0,0,1;1,0,0;0,0,1 negate")
def whitedarkgreenpurple():
    """Mixes the channels giving a white, dark green and purple tone to the image."""

@process_image('whitedarkindigored', "0,0,1;1,0,0;1,0,0 negate")
...
@process_image('whiteluminousgreen', "0,1,0;0,0,0;1,0,0 negate")
def whiteluminousgreen():
    """Mixes the channels giving a white and luminous green tone to the image."""

@process_image('purplealien', "0,1,0;0,0,;1,0,0 negate")
def purplealien():
    """Mixes the channels giving a white, purple and alien skin tone to the image."""
...
cli.add_command(whitedarkblueamber)
...
cli.add_command(whiteluminousgreen)
cli.add_command(purplealien)
